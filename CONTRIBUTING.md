...
Use [GitHub Issues](https://github.com/auron-labs/opencode-plugins/issues) for bugs and feature requests. For security vulnerabilities, see [SECURITY.md](./SECURITY.md).
